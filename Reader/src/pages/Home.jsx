  ...
  return (
    <div className='flex relative w-full h-full bg-bg1 bg-right bg-contain bg-no-repeat'>
      ...
      <div className='self-center w-1/2 space-y-8 pl-16'>
        ...
        <p className='text-justify font-medium'>LIBOO is not only a repository of information but also a vibrant community hub where individuals of all ages can come together to read, study, research, and connect. Join us in this virtual realm of literary exploration and convenience, where your love for books meets the convenience of the digital age.</p>
